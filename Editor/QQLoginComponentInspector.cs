...
namespace GameFrameX.Login.QQ.Editor
{
    [CustomEditor(typeof(QQLoginComponent))]
    internal sealed class QQLoginComponentInspector : ComponentTypeComponentInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("从 https://connect.qq.com 获取", MessageType.Warning);
        ...
        {
            RefreshComponentTypeNames(typeof(IQQLoginManager));
        }
    }
}